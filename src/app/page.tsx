...
const circleImages = [
  {
    id: 1,
    src: "https://i.pinimg.com/736x/0d/65/c0/0d65c08aef63fdc641037dd030c9dd38.jpg",
    alt: "Pink Lip Gloss",
    name: "Crystal Pink",
...
const heroImages = [
  {
    id: 1,
    src: "https://i.pinimg.com/1200x/c6/32/bd/c632bdf972f502e95adf8db114c65f03.jpg",
  ...
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 items-start">
      ...
      <section className="py-12 md:py-20 relative px-4 sm:px-6">
        <div className="absolute inset-0 z-0">
          <Image
            src="https://i.pinimg.com/1200x/87/79/1d/87791d0b59da49f5fa20eda57618de38.jpg"
            alt="Background"
            fill
            className="object-cover"
            sizes="100vw"
